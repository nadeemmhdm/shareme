/**
 * EasyQRCodeJS / Minimal standalone QR Code Canvas generator for CryptShare
 * 100% client-side, zero external requests, zero-knowledge.
 */
(function (root, factory) {
  ...
  // Simple, robust QR Code Canvas Generator
  ...
  QRCodeModel.prototype = {
    addData: function(data) {
      var byteObj = new QR8bitByte(data);
      byteObj.parsedData = stringToBytes(data);
      this.dataList.push(byteObj);
      this.dataCache = null;
    },
  ...
  function QRCode(targetElement, options) {
    ...
    var el = typeof targetElement === 'string' ? document.getElementById(targetElement) : targetElement;
    el.innerHTML = '';
    ...
    var qrcode = new QRCodeModel(0, options.correctLevel);
    qrcode.addData(options.text);
    qrcode.make();

    var count = qrcode.getModuleCount();
    var tileW = options.width / count;
    var tileH = options.height / count;
